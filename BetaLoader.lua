...
library.KeyBind = Enum.KeyCode.RightAlt
library.Modules = {}
	...
	lib.NewButton = function(Table)
		...
		lib2.ToggleButton = function(v)
			...
			if enabled then
				...
				CreateNotification("Essential", 5, Table.Name .. " has been enabled")
			else
				arraylist.Remove(Table.Name)
				CreateNotification("Essential", 5, Table.Name .. " has been disabled")
			end
	...
	Function = function(callback)
		if callback then
			...
			repeat task.wait(4)
                ...
                game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer("/// .gg/nvl ///", "All")
				task.wait(4)
				game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer("Break some beds with Essential // .gg/nvl | Essential On Top", "All")
				task.wait(4)
				game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer("Get some wins with Essential // .gg/nvl // | Essential On Top", "All")
                task.wait(4)
				game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer("ProtoSense? Never heard of it | Essential On Top", "All")
                task.wait(4)
				game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer("Anticheat? Never heard of it | Essential On Top", "All")
...
local function onPlayerDeath(deadPlayer)
    if deadPlayer.Team ~= player.Team then
        local messages = {
            "Essential On Top " .. deadPlayer.Name .. " | Essential On Top",
            "My gaming chair is too powerful " .. deadPlayer.Name .. " | Essential On Top",
            "I have a good gaming chair " .. deadPlayer.Name .. " | Essential On Top",
            "// .gg/nvl //" .. deadPlayer.Name .. " | Essential On Top",
            " " .. deadPlayer.Name .. " ? Never heard of it! | Essential On Top",
            "L " .. deadPlayer.Name .. " | Essential On Top",
            "Hahaha " .. deadPlayer.Name .. " | Essential On Top"
        }
            ...
            task.spawn(function()
                repeat task.wait()
                    ...
                    elseif Bypassmode == "Walkspeed" then
                        isEnabled = false
                        game.Players.LocalPlayer.Character.Humanoid.WalkSpeed = 25.3
                        local args = {
                            [1] = {
                                ["direction"] = Vector3.new(0.46722307801246643, -1.769954627306447e-09, -0.8841394782066345)
                            }
